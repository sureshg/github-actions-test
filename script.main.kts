#!/usr/bin/env -S kotlinc -script -Xplugin=/usr/local/Cellar/kotlin/1.5.30/libexec/lib/kotlinx-serialization-compiler-plugin.jar
...
@file:DependsOn("com.microsoft.playwright:playwright:1.14.1")
